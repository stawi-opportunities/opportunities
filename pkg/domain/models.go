...
type CanonicalJob struct {
	...
	// flows through the redirect service and gets recorded. Liveness
	// probing lives in service-files/redirect now — authoritative
	// last_checked_at / failure counters live on the Link row there,
	// not here.
