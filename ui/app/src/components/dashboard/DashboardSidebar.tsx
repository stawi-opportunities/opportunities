...
export type SectionId = 'feed' | 'matches' | 'saved' | 'preferences' | 'billing' | 'settings';
...
function SidebarNav({
  ...
  const sections = matchCount != null
  ...
  return (
    <>
      ...
      >
        ...
        {t(active === 'feed' ? 'nav.feed' : active === 'matches' ? 'nav.matches' : active === 'saved' ? 'nav.saved' : active === 'preferences' ? 'nav.preferences' : active === 'billing' ? 'nav.billing' : 'nav.settings')}
      </button>
