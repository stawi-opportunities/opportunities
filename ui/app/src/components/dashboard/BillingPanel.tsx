...
/**
 * Slim subscription card: current plan, change plan, cancel.
 * No usage charts or invoice history (those cluttered the job of "manage sub").
 */
export function BillingPanel({
  ...
  return (
    <Panel title={t('settings.sectionSubscription', 'Subscription')}>
      {cancelAtPeriodEnd && (
        <div
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-2 text-xs leading-relaxed text-secondary">
            Upgrade or downgrade anytime. Cancel keeps access until the period you already paid for
            ends.
          </p>
        </div>
