  ...
  const body =
    status === 'past_due'
      ...
      : status === 'cancelled'
        ...
        : plan
          ? 'Complete checkout to unlock matches, digests, and your plan caps.'
          : 'Choose a plan to get AI matches and digests. Matching requires an active subscription.';
  return (
