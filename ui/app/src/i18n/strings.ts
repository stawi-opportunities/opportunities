...
const en: Strings = {
  ...
  'settings.deleteAccountWarning': 'This action is permanent and cannot be undone. All your data will be deleted.',
  ...
  'settings.dataExportRequested': 'Data export requested. You will receive an email when it\'s ready.',
...
const es: Strings = {
  ...
  'settings.marketingEmailsHint': 'Consejos, actualizaciones del producto y perspectivas del mercado laboral.',
  ...
  'settings.deleteAccountWarning': 'Esta acción es permanente y no se puede deshacer. Todos sus datos serán eliminados.',
  ...
  'settings.dataExportRequested': 'Exportación de datos solicitada. Recibirá un correo cuando esté lista.',
...
const fr: Strings = {
  ...
  'settings.deleteAccountWarning': 'Cette action est permanente et irréversible. Toutes vos données seront supprimées.',
  'settings.deleteConfirm': 'Êtes-vous sûr de vouloir supprimer votre compte ?',
  'settings.deleteReason': 'Nous sommes désolés de vous voir partir. Dites-nous pourquoi (facultatif) :',
  'settings.accountDeleted': 'Compte supprimé avec succès.',
  'settings.dataExport': 'Exporter mes données',
  'settings.dataExportHint': 'Téléchargez toutes vos données de profil, correspondances et activités.',
  'settings.dataExportRequested': 'Exportation demandée. Vous recevrez un e-mail quand elle sera prête.',
...
const de: Strings = {
  ...
  'settings.matchAlertsHint': 'Benachrichtigt werden, wenn eine neue Übereinstimmung gefunden wird.',
  ...
  'settings.deleteAccountWarning': 'Diese Aktion ist endgültig und kann nicht rückgängig gemacht werden. Alle Ihre Daten werden gelöscht.',
  'settings.deleteConfirm': 'Sind Sie sicher, dass Sie Ihr Konto löschen möchten?',
  'settings.deleteReason': 'Es tut uns leid, Sie gehen zu sehen. Teilen Sie uns mit, warum (optional):',
  'settings.accountDeleted': 'Konto erfolgreich gelöscht.',
  'settings.dataExport': 'Meine Daten exportieren',
  'settings.dataExportHint': 'Laden Sie alle Ihre Profil-, Übereinstimmungs- und Aktivitätsdaten herunter.',
  'settings.dataExportRequested': 'Datenexport angefordert. Sie erhalten eine E-Mail, wenn er bereit ist.',
...
const pt: Strings = {
  ...
  'settings.marketingEmailsHint': 'Dicas, atualizações de produto e insights do mercado de trabalho.',
  ...
  'settings.deleteAccountWarning': 'Esta ação é permanente e não pode ser desfeita. Todos os seus dados serão excluídos.',
  ...
  'settings.dataExportRequested': 'Exportação de dados solicitada. Você receberá um e-mail quando estiver pronta.',
  'settings.language': 'Idioma',
...
const ja: Strings = {
  ...
  'settings.dataExportRequested': 'データエクスポートをリクエストしました。準備ができ次第メールでお知らせします。',
...
const ar: Strings = {
  ...
  'settings.dataExportRequested': 'تم طلب تصدير البيانات. ستتلقى بريداً إلكترونياً عندما يصبح جاهزاً.',
