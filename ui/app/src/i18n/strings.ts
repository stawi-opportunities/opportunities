...
const en: Strings = {
  ...
  'dash.welcomeBody': 'We match you with the best opportunities across Africa. Start by completing your profile and setting your preferences.',
...
const es: Strings = {
  ...
  'dash.welcomeBody': 'Te emparejamos con las mejores oportunidades en toda África. Comienza completando tu perfil y configurando tus preferencias.',
...
const fr: Strings = {
  ...
  'dash.welcomeBody': 'Nous vous mettons en relation avec les meilleures opportunités en Afrique. Commencez par compléter votre profil et définir vos préférences.',
...
const de: Strings = {
  ...
  'dash.welcomeBody': 'Wir verbinden Sie mit den besten Möglichkeiten in ganz Afrika. Vervollständigen Sie Ihr Profil und legen Sie Ihre Präferenzen fest.',
...
const pt: Strings = {
  ...
  'dash.welcomeBody': 'Conectamos você às melhores oportunidades em toda a África. Comece completando seu perfil e definindo suas preferências.',
...
const ja: Strings = {
  ...
  'dash.welcomeBody': 'アフリカ全土の最適な機会をマッチングします。プロフィールを完了し、希望条件を設定してください。',
...
const ar: Strings = {
  ...
  'dash.welcomeBody': 'نوفر لك أفضل الفرص في جميع أنحاء أفريقيا. ابدأ بإكمال ملفك الشخصي وتحديد تفضيلاتك.',
